...
const meetingService = require('./api/meeting-service');
const eventcenterService = require('./api/eventcenter-service');
const attendeeService = require('./api/attendee-service');
const generalsessionService = require('./api/generalsession-service');
...
class WebEx extends EventEmitter {
  ...
  processRes(res) {
    const xml2jsOptions = {
      ...
      valueProcessors: [processors.parseNumbers, processors.parseDate,
        processors.parseBooleans],
      attrValueProcessors: [processors.parseNumbers, processors.parseDate,
        processors.parseBooleans],
    };
